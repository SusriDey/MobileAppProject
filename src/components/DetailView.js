        ...
        return (
            ...
            <View>
                ...
                <ScrollView showsVerticalScrollIndicator={false}>
                    ...
                    <Button style={{backgroundColor: '#c64c38', Color:'#fff'}} icon="arrow-left" mode="text" onPress={() => noneSelected()}>
                    ...
                    <View style={styles.actionButtonContainerRoot}>
                        ...
                        <View style={styles.actionButtonContainer}>
                            ...
                            <Button style={{backgroundColor: '#c64c38', Color:'#fff'}} icon="phone" mode="contained" onPress={() => console.log('Pressed')}>
                        ...
                        <View style={styles.actionButtonContainer}>
                            ...
                            <Button style={{backgroundColor: '#c64c38', Color:'#fff'}} icon="email" mode="contained" onPress={() => console.log('Pressed')}>
                        ...
                        <View style={styles.actionButtonContainer}>
                            ...
                            <Button style={{backgroundColor: '#c64c38', Color:'#fff'}} icon="message-alert" mode="contained" onPress={() => console.log('Pressed')}>
