            ...
            <ScrollView showsVerticalScrollIndicator={false}>
                ...
                <View style={styles.form}>
                    ...
                    <View style={styles.updateButton}>
                        ...
                        <Button style={{backgroundColor: '#c64c38', Color: '#fff'}} mode="contained" onPress={this.onUpdatePress.bind(this)}>
                    ...
                    <View style={styles.updateButton}>
                        ...
                        <Button style={{backgroundColor: '#c64c38', Color: '#fff' }} mode="contained" onPress={this.onCancelPress.bind(this)}>
